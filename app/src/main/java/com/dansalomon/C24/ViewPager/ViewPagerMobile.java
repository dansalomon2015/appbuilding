...
import com.dansalomon.C24.Mobile_tabs.Jour;
 ...
 */
public class ViewPagerMobile extends FragmentStatePagerAdapter {
    ...
    public ViewPagerMobile(FragmentManager fm,CharSequence mTitles[], int mNumbOfTabsumb) {
        super(fm);
