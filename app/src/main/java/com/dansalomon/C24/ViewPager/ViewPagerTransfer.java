...
import com.dansalomon.C24.Transfer_tabs.International;
import com.dansalomon.C24.Transfer_tabs.National;

/**
 * Created by Edwin on 15/02/2015.
 */
public class ViewPagerTransfer extends FragmentStatePagerAdapter {
    ...
    public ViewPagerTransfer(FragmentManager fm, CharSequence mTitles[], int mNumbOfTabsumb) {
        super(fm);
